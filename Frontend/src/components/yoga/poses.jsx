...
function Poses({ goBackToTrimester }) {
  ...
  return (
    ...
    >
      ...
      {activePose === "ChildPose" && (
        <ChildPose goBackToPoses={handleBackToPoses} />
      )}
      {activePose === "BridgePose" && (
        <BridgePose goBackToPoses={handleBackToPoses} />
      )}
      {activePose === "GarlandPose" && (
        <GarlandPose goBackToPoses={handleBackToPoses} />
      )}
      {activePose === "ButterflyPose" && (
        <ButterflyPose goBackToPoses={handleBackToPoses} />
      )}
      {activePose === "AnkleRotation" && (
        <AnkleRotation goBackToPoses={handleBackToPoses} />
      )}
            ...
            {[
              {
                img: y1,
                alt: "Child Pose",
                onClick: () => setActivePose("ChildPose"),
              },
              {
                img: y2,
                alt: "Bridge Pose",
                onClick: () => setActivePose("BridgePose"),
              },
              {
                img: y3,
                alt: "Garland Pose",
                onClick: () => setActivePose("GarlandPose"),
              },
            ...
            {[
              {
                img: y4,
                alt: "Butterfly Pose",
                onClick: () => setActivePose("ButterflyPose"),
              },
              {
                img: y5,
                alt: "Ankle Rotation",
                onClick: () => setActivePose("AnkleRotation"),
              },
